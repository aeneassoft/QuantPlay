...
_CACHE_DEFAULT = {5: "_gto_river_cache", 4: "_gto_turn_cache"}.get(STREET, "_gto_bench_cache")
CACHE = config.DATA_DIR / os.environ.get("CACHE_NAME", _CACHE_DEFAULT)   # override dir (e.g. DUMP=2 turn+river set)
