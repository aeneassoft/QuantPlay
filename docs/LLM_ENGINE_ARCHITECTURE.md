...
- **LLM** = reduce / **generalize** fuzzy, high-dimensional data → a *small* choice. (The user's words: *"in der Lage,
  viele Daten zu vereinfachen und zu generalisieren."*) It is NOT good at exact computation.
