...
Consolidates the RL book + the DAPO paper + the converged consults (`qwen_train_claude.md`, `qwen_train_gpt55.md`,
...
- **`beta` 0 vs ~0.04:** 0 = DAPO (diverge from teacher, cheaper, no ref model); ~0.04 = the poker-noise anti-collapse
  hedge (`qwen_train_claude.md`). Start 0 (we have other anti-collapse: R_CLIP, CRN, format reward, decaying shaping,
...
- **Recipe/gates:** `docs/qwen_train_claude.md` · **thesis:** `docs/qwen_train_gpt55.md` · **spine:** `docs/QWEN_6MAX_PLAN.md` · **SFT staging:** `docs/llm_curriculum.md` · **alarms:** `docs/first_rl_run_expectations.md`
