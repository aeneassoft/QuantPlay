...
The user asked, after the engine landed #11 on GTO Wizard's public leaderboard: *"It seems to me that we have made
mathematical progress that could be substantial. Or at least built a novel path in the program and
in computer science."* — Check that.
