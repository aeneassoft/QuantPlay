...
> Living entry point. Read this first, then [CLAUDE.md](../CLAUDE.md) (north star + conventions) + [INDEX.md](../INDEX.md) (live repo tree). Last updated **2026-06-28**.
...
> **★ NEXT (user directive): get the ENGINE top-notch INDEPENDENT of RL; RL only once the engine is excellent.** The RIVER is the remaining real leak — tackle ENGINE-side (solver-wiring / nuanced value + bluff-catch calibration), NOT RL. (The GLM-brain −55-raw / RL story below is SEPARATE + deferred.)
