...
> below −8): `../reports/RESEARCH_SWEEP_2026-07-05.md`. Everything below = the 2026-07-04 founding context.
...
- The bleed = POSTFLOP: river −8.6 + flop −8.3 bb/100. Opponent intel: GTOW = the Ruse REAL-TIME re-solver —
  translation/bet-size attacks REFUTED ($0, 13.5k hands): `../reports/GTOW_DOSSIER.md`.

## THE ACTIVE BUILD CARD → `../plans/VERSION_PRINCE.md` (§3b = the merged build order from 3 deep audits)
...
- Key files: `../plans/VERSION_PRINCE.md` (build card) · `docs/STATE.md` (live truth) · `../reports/GTOW_DOSSIER.md` (opponent)
  · `../plans/TIE_GTOW.md` (ledger) · `data/gtow_grades/LEAK_MAP.md` (per-decision leaks) · `../INDEX.md` (map).
