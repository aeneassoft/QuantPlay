...
def _process_cache(cache_dir, street, nboard):
...
def main() -> None:
    rows = []
    for cache_dir, street, nboard in ((_CACHE, "flop", 3), (RIVER_CACHE, "river", 5)):
        r, used = _process_cache(cache_dir, street, nboard)
        rows.extend(r)
